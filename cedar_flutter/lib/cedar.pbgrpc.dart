...
class CedarClient extends $grpc.Client {
  ...
  static final _$getFrames = $grpc.ClientMethod<$0.FrameRequest, $0.FrameResult>(
  ...
  static final _$removeBond = $grpc.ClientMethod<$0.RemoveBondRequest, $0.EmptyMessage>(
      ...
      ($core.List<$core.int> value) => $0.EmptyMessage.fromBuffer(value));
  static final _$scanWifi = $grpc.ClientMethod<$0.EmptyMessage, $0.WifiScanResponse>(
...
abstract class CedarServiceBase extends $grpc.Service {
  ...
  CedarServiceBase() {
    ...
    $addMethod($grpc.ServiceMethod<$0.RemoveBondRequest, $0.EmptyMessage>(
        ...
        ($0.EmptyMessage value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$0.EmptyMessage, $0.WifiScanResponse>(
        'ScanWifi',
        scanWifi_Pre,
        false,
        false,
  ...
  $async.Future<$0.WifiScanResponse> scanWifi_Pre($grpc.ServiceCall $call, $async.Future<$0.EmptyMessage> $request) async {
