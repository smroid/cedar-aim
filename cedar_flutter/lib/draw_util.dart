...
// Catalog-labeling functions (labelForEntry, commonNameForEntry,
// bestDesignation, isSpecialCatalogLabel) have moved to hopper_flutter's
// catalog_labeling.dart. Callers in this shared package receive them
// injected as an ObjectLabelingFunctions bundle by the Hopper-specific
// caller, rather than calling free functions directly.
class ObjectLabelingFunctions {
  final String Function(CatalogEntry) labelForEntry;
  final String Function(CatalogEntry) commonNameForEntry;
  final CatalogEntry Function(CatalogEntry, Iterable<CatalogEntry>)
      bestDesignation;

  ObjectLabelingFunctions({
    required this.labelForEntry,
    required this.commonNameForEntry,
    required this.bestDesignation,
  });
}
