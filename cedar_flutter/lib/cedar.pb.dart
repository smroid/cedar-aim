...
class ServerInformation extends $pb.GeneratedMessage {
  factory ServerInformation({
    ...
    if (systemLoadAverage != null) result.systemLoadAverage = systemLoadAverage;
    if (cpuCoreCount != null) result.cpuCoreCount = cpuCoreCount;
    if (cedarLoadAverage != null) result.cedarLoadAverage = cedarLoadAverage;
    return result;
  }
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$3.Timestamp>(8, _omitFieldNames ? '' : 'serverTime',
    ...
    ..aOM<ConnectionStatus>(17, _omitFieldNames ? '' : 'connectionStatus',
        subBuilder: ConnectionStatus.create)
    ..a<$core.double>(
        18, _omitFieldNames ? '' : 'systemLoadAverage', $pb.PbFieldType.OF)
    ..a<$core.int>(
        19, _omitFieldNames ? '' : 'cpuCoreCount', $pb.PbFieldType.O3)
    ..a<$core.double>(
        20, _omitFieldNames ? '' : 'cedarLoadAverage', $pb.PbFieldType.OF)
  ...
  @$pb.TagNumber(8)
  set serverTime($3.Timestamp value) => $_setField(8, value);
  @$pb.TagNumber(8)
  ...
  @$pb.TagNumber(17)
  set connectionStatus(ConnectionStatus value) => $_setField(17, value);
  @$pb.TagNumber(17)
  ...
  @$pb.TagNumber(18)
  set systemLoadAverage($core.double value) => $_setFloat(17, value);
  @$pb.TagNumber(18)
  ...
  @$pb.TagNumber(19)
  set cpuCoreCount($core.int value) => $_setSignedInt32(18, value);
  @$pb.TagNumber(19)
  ...
  @$pb.TagNumber(20)
  set cedarLoadAverage($core.double value) => $_setFloat(19, value);
  @$pb.TagNumber(20)
...
class ConnectionStatus extends $pb.GeneratedMessage {
  factory ConnectionStatus({
    ...
    final result = create();
    if (cedarWifi != null) result.cedarWifi = cedarWifi;
    if (cedarBluetooth != null) result.cedarBluetooth = cedarBluetooth;
    if (lx200Wifi != null) result.lx200Wifi = lx200Wifi;
    if (lx200Bluetooth != null) result.lx200Bluetooth = lx200Bluetooth;
    return result;
  }

  ConnectionStatus._();

  factory ConnectionStatus.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory ConnectionStatus.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'ConnectionStatus',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'cedar'),
      createEmptyInstance: create)
    ..a<$core.int>(1, _omitFieldNames ? '' : 'cedarWifi', $pb.PbFieldType.O3)
    ..a<$core.int>(
        2, _omitFieldNames ? '' : 'cedarBluetooth', $pb.PbFieldType.O3)
    ..a<$core.int>(3, _omitFieldNames ? '' : 'lx200Wifi', $pb.PbFieldType.O3)
    ..a<$core.int>(
        4, _omitFieldNames ? '' : 'lx200Bluetooth', $pb.PbFieldType.O3)
    ..hasRequiredFields = false;

  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ConnectionStatus clone() => ConnectionStatus()..mergeFromMessage(this);
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ConnectionStatus copyWith(void Function(ConnectionStatus) updates) =>
      super.copyWith((message) => updates(message as ConnectionStatus))
          as ConnectionStatus;
  ...
  static $pb.PbList<ConnectionStatus> createRepeated() =>
      $pb.PbList<ConnectionStatus>();
  @$core.pragma('dart2js:noInline')
  static ConnectionStatus getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<ConnectionStatus>(create);
  ...
  @$pb.TagNumber(1)
  set cedarWifi($core.int value) => $_setSignedInt32(0, value);
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(2)
  set cedarBluetooth($core.int value) => $_setSignedInt32(1, value);
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(3)
  set lx200Wifi($core.int value) => $_setSignedInt32(2, value);
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(4)
  set lx200Bluetooth($core.int value) => $_setSignedInt32(3, value);
  @$pb.TagNumber(4)
...
class FixedSettings extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$3.Timestamp>(4, _omitFieldNames ? '' : 'currentTime',
        subBuilder: $3.Timestamp.create)
    ..aOS(5, _omitFieldNames ? '' : 'sessionName')
    ..aOM<$4.Duration>(6, _omitFieldNames ? '' : 'maxExposureTime',
  ...
  @$pb.TagNumber(4)
  set currentTime($3.Timestamp value) => $_setField(4, value);
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(6)
  set maxExposureTime($4.Duration value) => $_setField(6, value);
  @$pb.TagNumber(6)
...
class OperationSettings extends $pb.GeneratedMessage {
  factory OperationSettings({
    ...
    if (detectSensitivity != null) result.detectSensitivity = detectSensitivity;
    return result;
  }
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..e<DetectSensitivity>(
        17, _omitFieldNames ? '' : 'detectSensitivity', $pb.PbFieldType.OE,
        defaultOrMaker: DetectSensitivity.SENSITIVITY_UNSPECIFIED,
        valueOf: DetectSensitivity.valueOf,
        enumValues: DetectSensitivity.values)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(17)
  set detectSensitivity(DetectSensitivity value) => $_setField(17, value);
  @$pb.TagNumber(17)
...
class Preferences extends $pb.GeneratedMessage {
  factory Preferences({
    ...
    if (skipFocus != null) result.skipFocus = skipFocus;
  ...
  /// * If successful, the server advances to SETUP boresight aligning or OPERATE
  ///   mode.
  /// * If unsuccessful, the
  ///   FrameResult.calibration_data.calibration_failure_reason field is
  ///   populated and the post-focus calibrations are retried every 30 seconds.
  @$pb.TagNumber(35)
  $core.bool get skipFocus => $_getBF(20);
  @$pb.TagNumber(35)
  set skipFocus($core.bool value) => $_setBool(20, value);
  @$pb.TagNumber(35)
  ...
  /// mode.
  @$pb.TagNumber(36)
  $core.bool get skipAlignment => $_getBF(21);
  @$pb.TagNumber(36)
  set skipAlignment($core.bool value) => $_setBool(21, value);
  @$pb.TagNumber(36)
...
class FrameRequest extends $pb.GeneratedMessage {
  factory FrameRequest({
    ...
    if (prevSolutionId != null) result.prevSolutionId = prevSolutionId;
    return result;
  }
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..a<$core.int>(
        4, _omitFieldNames ? '' : 'prevSolutionId', $pb.PbFieldType.O3)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(4)
  set prevSolutionId($core.int value) => $_setSignedInt32(3, value);
  @$pb.TagNumber(4)
...
class FrameResult extends $pb.GeneratedMessage {
  factory FrameResult({
    ...
    if (skipFocusActive != null) result.skipFocusActive = skipFocusActive;
    if (hotPixelCount != null) result.hotPixelCount = hotPixelCount;
    ...
    if (solutionId != null) result.solutionId = solutionId;
    return result;
  }
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$4.Duration>(7, _omitFieldNames ? '' : 'exposureTime',
        subBuilder: $4.Duration.create)
    ..aOM<ProcessingStats>(8, _omitFieldNames ? '' : 'processingStats',
        subBuilder: ProcessingStats.create)
    ..aOM<$3.Timestamp>(9, _omitFieldNames ? '' : 'captureTime',
        subBuilder: $3.Timestamp.create)
    ...
    ..a<$core.int>(
        39, _omitFieldNames ? '' : 'hotPixelCount', $pb.PbFieldType.O3)
    ..aOM<FovCatalogEntry>(40, _omitFieldNames ? '' : 'boresightCatalogEntry',
        subBuilder: FovCatalogEntry.create)
    ..aOM<$1.Constellation>(41, _omitFieldNames ? '' : 'boresightConstellation',
        subBuilder: $1.Constellation.create)
    ..a<$core.double>(
        42,
        _omitFieldNames ? '' : 'boresightCatalogEntryDistance',
        $pb.PbFieldType.OF)
  ...
  @$pb.TagNumber(7)
  set exposureTime($4.Duration value) => $_setField(7, value);
  @$pb.TagNumber(7)
  ...
  @$pb.TagNumber(9)
  set captureTime($3.Timestamp value) => $_setField(9, value);
  @$pb.TagNumber(9)
  ...
  /// True when the server is in skip-focus auto-calibration mode with retries.
  /// The user must disable the skip_focus preference to exit this mode.
  @$pb.TagNumber(38)
  $core.bool get skipFocusActive => $_getBF(28);
  @$pb.TagNumber(38)
  set skipFocusActive($core.bool value) => $_setBool(28, value);
  @$pb.TagNumber(38)
  ...
  @$pb.TagNumber(39)
  set hotPixelCount($core.int value) => $_setSignedInt32(29, value);
  @$pb.TagNumber(39)
  ...
  @$pb.TagNumber(40)
  set boresightCatalogEntry(FovCatalogEntry value) => $_setField(40, value);
  @$pb.TagNumber(40)
  ...
  @$pb.TagNumber(41)
  set boresightConstellation($1.Constellation value) => $_setField(41, value);
  @$pb.TagNumber(41)
  ...
  @$pb.TagNumber(42)
  set boresightCatalogEntryDistance($core.double value) =>
      $_setFloat(32, value);
  @$pb.TagNumber(42)
  ...
  @$pb.TagNumber(43)
  set solutionId($core.int value) => $_setSignedInt32(33, value);
  @$pb.TagNumber(43)
...
class StarCentroid extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(7)
  set magnitude($core.double value) => $_setDouble(3, value);
  @$pb.TagNumber(7)
...
class PlateSolution extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(_omitMessageNames ? '' : 'cedar'),
      createEmptyInstance: create)
    ..aOM<$2.CelestialCoord>(1, _omitFieldNames ? '' : 'imageSkyCoord',
        subBuilder: $2.CelestialCoord.create)
    ...
    ..aOM<$4.Duration>(12, _omitFieldNames ? '' : 'solveTime',
        subBuilder: $4.Duration.create)
    ..pc<$2.CelestialCoord>(
  ...
  @$pb.TagNumber(1)
  set imageSkyCoord($2.CelestialCoord value) => $_setField(1, value);
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(12)
  set solveTime($4.Duration value) => $_setField(12, value);
  @$pb.TagNumber(12)
  ...
  @$pb.TagNumber(13)
  $pb.PbList<$2.CelestialCoord> get targetSkyCoord => $_getList(12);
...
class StarInfo extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<ImageCoord>(1, _omitFieldNames ? '' : 'pixel',
        subBuilder: ImageCoord.create)
    ..aOM<$2.CelestialCoord>(2, _omitFieldNames ? '' : 'skyCoord',
        subBuilder: $2.CelestialCoord.create)
  ...
  @$pb.TagNumber(2)
  set skyCoord($2.CelestialCoord value) => $_setField(2, value);
  @$pb.TagNumber(2)
...
class ProcessingStats extends $pb.GeneratedMessage {
  factory ProcessingStats({
    ...
    if (solveOtherLatency != null) result.solveOtherLatency = solveOtherLatency;
    return result;
  }
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<ValueStats>(9, _omitFieldNames ? '' : 'acquireLatency',
        subBuilder: ValueStats.create)
    ..aOM<ValueStats>(10, _omitFieldNames ? '' : 'detectOtherLatency',
        subBuilder: ValueStats.create)
    ..aOM<ValueStats>(11, _omitFieldNames ? '' : 'solveOtherLatency',
        subBuilder: ValueStats.create)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(10)
  set detectOtherLatency(ValueStats value) => $_setField(10, value);
  @$pb.TagNumber(10)
  ...
  @$pb.TagNumber(11)
  set solveOtherLatency(ValueStats value) => $_setField(11, value);
  @$pb.TagNumber(11)
...
class CalibrationData extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(_omitMessageNames ? '' : 'cedar'),
      createEmptyInstance: create)
    ..aOM<$3.Timestamp>(1, _omitFieldNames ? '' : 'calibrationTime',
        subBuilder: $3.Timestamp.create)
    ..aOM<$4.Duration>(2, _omitFieldNames ? '' : 'targetExposureTime',
        subBuilder: $4.Duration.create)
    ...
    ..a<$core.int>(
        23, _omitFieldNames ? '' : 'brightSpotMapCount', $pb.PbFieldType.O3)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(1)
  set calibrationTime($3.Timestamp value) => $_setField(1, value);
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(2)
  set targetExposureTime($4.Duration value) => $_setField(2, value);
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(23)
  set brightSpotMapCount($core.int value) => $_setSignedInt32(18, value);
  @$pb.TagNumber(23)
...
class SlewRequest extends $pb.GeneratedMessage {
  factory SlewRequest({
    ...
    if (targetAltAz != null) result.targetAltAz = targetAltAz;
    return result;
  }
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(_omitMessageNames ? '' : 'cedar'),
      createEmptyInstance: create)
    ..aOM<$2.CelestialCoord>(1, _omitFieldNames ? '' : 'target',
        subBuilder: $2.CelestialCoord.create)
    ..a<$core.double>(
    ...
    ..aOM<$2.HorizonCoord>(10, _omitFieldNames ? '' : 'targetAltAz',
        subBuilder: $2.HorizonCoord.create)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(1)
  set target($2.CelestialCoord value) => $_setField(1, value);
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(10)
  $2.HorizonCoord get targetAltAz => $_getN(7);
  @$pb.TagNumber(10)
  set targetAltAz($2.HorizonCoord value) => $_setField(10, value);
  @$pb.TagNumber(10)
  $core.bool hasTargetAltAz() => $_has(7);
  @$pb.TagNumber(10)
  void clearTargetAltAz() => $_clearField(10);
  @$pb.TagNumber(10)
  $2.HorizonCoord ensureTargetAltAz() => $_ensure(7);
}
...
class FovCatalogEntry extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..pc<$1.CatalogEntry>(
        5, _omitFieldNames ? '' : 'dedupedEntries', $pb.PbFieldType.PM,
        subBuilder: $1.CatalogEntry.create)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(4)
  set azimuth($core.double value) => $_setDouble(3, value);
  @$pb.TagNumber(4)
...
class ActionRequest extends $pb.GeneratedMessage {
  factory ActionRequest({
    ...
    if (resetHotPixelMap != null) result.resetHotPixelMap = resetHotPixelMap;
    if (wifiEnabled != null) result.wifiEnabled = wifiEnabled;
    if (initiateSlewAltAz != null) result.initiateSlewAltAz = initiateSlewAltAz;
    return result;
  }
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$2.CelestialCoord>(6, _omitFieldNames ? '' : 'initiateSlew',
        subBuilder: $2.CelestialCoord.create)
    ...
    ..aOM<$2.HorizonCoord>(16, _omitFieldNames ? '' : 'initiateSlewAltAz',
        subBuilder: $2.HorizonCoord.create)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(6)
  set initiateSlew($2.CelestialCoord value) => $_setField(6, value);
  @$pb.TagNumber(6)
  ...
  @$pb.TagNumber(13)
  set calibrateDarkFrame($core.bool value) => $_setBool(12, value);
  @$pb.TagNumber(13)
  ...
  @$pb.TagNumber(14)
  set resetHotPixelMap($core.bool value) => $_setBool(13, value);
  @$pb.TagNumber(14)
  ...
  @$pb.TagNumber(15)
  set wifiEnabled($core.bool value) => $_setBool(14, value);
  @$pb.TagNumber(15)
  ...
  /// known.
  @$pb.TagNumber(16)
  $2.HorizonCoord get initiateSlewAltAz => $_getN(15);
  @$pb.TagNumber(16)
  set initiateSlewAltAz($2.HorizonCoord value) => $_setField(16, value);
  @$pb.TagNumber(16)
...
class CpuUsageReport extends $pb.GeneratedMessage {
  ...
  factory CpuUsageReport.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory CpuUsageReport.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'CpuUsageReport',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'cedar'),
      createEmptyInstance: create)
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  CpuUsageReport copyWith(void Function(CpuUsageReport) updates) =>
      super.copyWith((message) => updates(message as CpuUsageReport))
          as CpuUsageReport;
  ...
  static $pb.PbList<CpuUsageReport> createRepeated() =>
      $pb.PbList<CpuUsageReport>();
  @$core.pragma('dart2js:noInline')
  static CpuUsageReport getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<CpuUsageReport>(create);
...
class SetPairingModeRequest extends $pb.GeneratedMessage {
  ...
  SetPairingModeRequest._();

  factory SetPairingModeRequest.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory SetPairingModeRequest.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'SetPairingModeRequest',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'cedar'),
      createEmptyInstance: create)
    ..aOB(1, _omitFieldNames ? '' : 'enabled')
    ..aOB(2, _omitFieldNames ? '' : 'forever')
    ..hasRequiredFields = false;

  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  SetPairingModeRequest clone() =>
      SetPairingModeRequest()..mergeFromMessage(this);
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  SetPairingModeRequest copyWith(
          void Function(SetPairingModeRequest) updates) =>
      super.copyWith((message) => updates(message as SetPairingModeRequest))
          as SetPairingModeRequest;

  @$core.override
  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static SetPairingModeRequest create() => SetPairingModeRequest._();
  @$core.override
  SetPairingModeRequest createEmptyInstance() => create();
  static $pb.PbList<SetPairingModeRequest> createRepeated() =>
      $pb.PbList<SetPairingModeRequest>();
  @$core.pragma('dart2js:noInline')
  static SetPairingModeRequest getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<SetPairingModeRequest>(create);
  static SetPairingModeRequest? _defaultInstance;
  ...
  /// indefinitely.
  @$pb.TagNumber(2)
  $core.bool get forever => $_getBF(1);
  @$pb.TagNumber(2)
  set forever($core.bool value) => $_setBool(1, value);
  @$pb.TagNumber(2)
...
class ImageRequest extends $pb.GeneratedMessage {
  ...
  factory ImageRequest.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory ImageRequest.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'ImageRequest',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'cedar'),
      createEmptyInstance: create)
    ..e<ImageFormat>(1, _omitFieldNames ? '' : 'format', $pb.PbFieldType.OE,
        defaultOrMaker: ImageFormat.IMAGE_FORMAT_UNSPECIFIED,
        valueOf: ImageFormat.valueOf,
        enumValues: ImageFormat.values)
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ImageRequest copyWith(void Function(ImageRequest) updates) =>
      super.copyWith((message) => updates(message as ImageRequest))
          as ImageRequest;
  ...
  static $pb.PbList<ImageRequest> createRepeated() =>
      $pb.PbList<ImageRequest>();
  @$core.pragma('dart2js:noInline')
  static ImageRequest getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<ImageRequest>(create);
  static ImageRequest? _defaultInstance;

  @$pb.TagNumber(1)
  ImageFormat get format => $_getN(0);
  @$pb.TagNumber(1)
  set format(ImageFormat value) => $_setField(1, value);
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(2)
  set quality($core.int value) => $_setSignedInt32(1, value);
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(3)
  set prevFrameId($core.int value) => $_setSignedInt32(2, value);
  @$pb.TagNumber(3)
...
class ImageResult extends $pb.GeneratedMessage {
  factory ImageResult({
    ...
    if (width != null) result.width = width;
    if (height != null) result.height = height;
    if (acquireTime != null) result.acquireTime = acquireTime;
    if (exposureTime != null) result.exposureTime = exposureTime;
    if (cameraGain != null) result.cameraGain = cameraGain;
    if (camera != null) result.camera = camera;
  ...
  factory ImageResult.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory ImageResult.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'ImageResult',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'cedar'),
      createEmptyInstance: create)
    ..a<$core.int>(1, _omitFieldNames ? '' : 'frameId', $pb.PbFieldType.O3)
    ..a<$core.int>(2, _omitFieldNames ? '' : 'width', $pb.PbFieldType.O3)
    ..a<$core.int>(3, _omitFieldNames ? '' : 'height', $pb.PbFieldType.O3)
    ..aOM<$3.Timestamp>(4, _omitFieldNames ? '' : 'acquireTime',
        subBuilder: $3.Timestamp.create)
    ..aOM<$4.Duration>(5, _omitFieldNames ? '' : 'exposureTime',
        subBuilder: $4.Duration.create)
    ..a<$core.int>(6, _omitFieldNames ? '' : 'cameraGain', $pb.PbFieldType.O3)
    ..aOM<CameraModel>(7, _omitFieldNames ? '' : 'camera',
        subBuilder: CameraModel.create)
    ..a<$core.List<$core.int>>(
        8, _omitFieldNames ? '' : 'imageChunk', $pb.PbFieldType.OY)
    ..hasRequiredFields = false;

  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ImageResult clone() => ImageResult()..mergeFromMessage(this);
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ImageResult copyWith(void Function(ImageResult) updates) =>
      super.copyWith((message) => updates(message as ImageResult))
          as ImageResult;
  ...
  @$core.pragma('dart2js:noInline')
  static ImageResult getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<ImageResult>(create);
  ...
  @$pb.TagNumber(4)
  $3.Timestamp get acquireTime => $_getN(3);
  @$pb.TagNumber(4)
  set acquireTime($3.Timestamp value) => $_setField(4, value);
  @$pb.TagNumber(4)
  $core.bool hasAcquireTime() => $_has(3);
  @$pb.TagNumber(4)
  void clearAcquireTime() => $_clearField(4);
  @$pb.TagNumber(4)
  $3.Timestamp ensureAcquireTime() => $_ensure(3);

  /// Exposure duration.
  @$pb.TagNumber(5)
  $4.Duration get exposureTime => $_getN(4);
  @$pb.TagNumber(5)
  set exposureTime($4.Duration value) => $_setField(5, value);
  @$pb.TagNumber(5)
  $core.bool hasExposureTime() => $_has(4);
  @$pb.TagNumber(5)
  void clearExposureTime() => $_clearField(5);
  @$pb.TagNumber(5)
  $4.Duration ensureExposureTime() => $_ensure(4);

  /// Camera gain setting [0..100], if relevant.
  @$pb.TagNumber(6)
  $core.int get cameraGain => $_getIZ(5);
  @$pb.TagNumber(6)
  set cameraGain($core.int value) => $_setSignedInt32(5, value);
  @$pb.TagNumber(6)
  ...
  @$pb.TagNumber(7)
  set camera(CameraModel value) => $_setField(7, value);
  @$pb.TagNumber(7)
  ...
  @$pb.TagNumber(8)
  set imageChunk($core.List<$core.int> value) => $_setBytes(7, value);
  @$pb.TagNumber(8)
