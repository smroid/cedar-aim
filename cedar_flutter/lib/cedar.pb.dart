...
class ServerInformation extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(8)
  set serverTime($3.Timestamp v) { $_setField(8, v); }
  @$pb.TagNumber(8)
...
class FixedSettings extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(4)
  set currentTime($3.Timestamp v) { $_setField(4, v); }
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(6)
  set maxExposureTime($4.Duration v) { $_setField(6, v); }
  @$pb.TagNumber(6)
...
class Preferences extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(35)
  set skipFocus($core.bool v) { $_setBool(20, v); }
  @$pb.TagNumber(35)
  ...
  @$pb.TagNumber(36)
  set skipAlignment($core.bool v) { $_setBool(21, v); }
  @$pb.TagNumber(36)
...
class FrameResult extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(7)
  set exposureTime($4.Duration v) { $_setField(7, v); }
  @$pb.TagNumber(7)
  ...
  @$pb.TagNumber(9)
  set captureTime($3.Timestamp v) { $_setField(9, v); }
  @$pb.TagNumber(9)
  ...
  @$pb.TagNumber(38)
  set skipFocusActive($core.bool v) { $_setBool(28, v); }
  @$pb.TagNumber(38)
...
class PlateSolution extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(1)
  set imageSkyCoord($2.CelestialCoord v) { $_setField(1, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(12)
  set solveTime($4.Duration v) { $_setField(12, v); }
  @$pb.TagNumber(12)
...
class StarInfo extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(2)
  set skyCoord($2.CelestialCoord v) { $_setField(2, v); }
  @$pb.TagNumber(2)
...
class CalibrationData extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(1)
  set calibrationTime($3.Timestamp v) { $_setField(1, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(2)
  set targetExposureTime($4.Duration v) { $_setField(2, v); }
  @$pb.TagNumber(2)
...
class SlewRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SlewRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'cedar'), createEmptyInstance: create)
    ...
    ..aOM<$2.HorizonCoord>(10, _omitFieldNames ? '' : 'targetAltAz', subBuilder: $2.HorizonCoord.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  set target($2.CelestialCoord v) { $_setField(1, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(10)
  set targetAltAz($2.HorizonCoord v) { $_setField(10, v); }
  @$pb.TagNumber(10)
...
class ActionRequest extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(6)
  set initiateSlew($2.CelestialCoord v) { $_setField(6, v); }
  @$pb.TagNumber(6)
  ...
  @$pb.TagNumber(16)
  set initiateSlewAltAz($2.HorizonCoord v) { $_setField(16, v); }
  @$pb.TagNumber(16)
...
class SetPairingModeRequest extends $pb.GeneratedMessage {
  ...
  SetPairingModeRequest._() : super();
  factory SetPairingModeRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory SetPairingModeRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SetPairingModeRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'cedar'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  SetPairingModeRequest clone() => SetPairingModeRequest()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  SetPairingModeRequest copyWith(void Function(SetPairingModeRequest) updates) => super.copyWith((message) => updates(message as SetPairingModeRequest)) as SetPairingModeRequest;
  ...
  static $pb.PbList<SetPairingModeRequest> createRepeated() => $pb.PbList<SetPairingModeRequest>();
  @$core.pragma('dart2js:noInline')
  static SetPairingModeRequest getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<SetPairingModeRequest>(create);
  ...
  @$pb.TagNumber(2)
  set forever($core.bool v) { $_setBool(1, v); }
  @$pb.TagNumber(2)
...
class ImageResult extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ImageResult', package: const $pb.PackageName(_omitMessageNames ? '' : 'cedar'), createEmptyInstance: create)
    ...
    ..aOM<$3.Timestamp>(4, _omitFieldNames ? '' : 'acquireTime', subBuilder: $3.Timestamp.create)
  ...
  @$pb.TagNumber(4)
  set acquireTime($3.Timestamp v) { $_setField(4, v); }
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(5)
  set exposureTime($4.Duration v) { $_setField(5, v); }
  @$pb.TagNumber(5)
